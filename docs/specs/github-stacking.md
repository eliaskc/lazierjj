...
### Tools to Evaluate for Integration

**[jj-ryu](https://github.com/dmmulroy/jj-ryu)** — Stacked PRs for jj (Rust, actively maintained)
- Graphite-inspired CLI: `ryu track`, `ryu submit`, `ryu sync`
- Explicit tracking before submit (good control)
- Stack navigation comments in PRs
- GitLab support
- **Evaluate thoroughly when starting implementation** — could use as backend rather than building from scratch
