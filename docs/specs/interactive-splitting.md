...
**Status**: Planning  
**Priority**: Medium  
**Depends on**: [Custom Diff Renderer](diff-renderer.md) Phases 1-2
...
Line-level anchors are defined in [review.md](./review.md) and should be reused for splitting without persisting split selections.
...
- [Custom Diff Renderer](diff-renderer.md) - Same renderer, split mode enabled
